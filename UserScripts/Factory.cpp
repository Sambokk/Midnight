...
GameObject* Factory::CreatePlayer(Vector2 _position)
{
	...
	playerCollider->SetOffset(Vector2(20.f, -10.f));
...
GameObject* Factory::CreateRabbit(Vector2 _position)
{
	...
	seinCollider->SetScale(Vector2(60.f, 80.f));
...
// 	ParticleSystem* featherPaticleSystem = feather->CreateComponent<ParticleSystem>();
// 	featherPaticleSystem->AddDefaultParticle(L"smoke1");
// 	featherPaticleSystem->AddDefaultParticle(L"smoke2");
// 	featherPaticleSystem->AddDefaultParticle(L"smoke3");
// 
// 	featherPaticleSystem->m_shape = EMISSION_SHAPE::CIRCLE;
// 	featherPaticleSystem->m_offset = Vector2(0, 0);
// 	featherPaticleSystem->m_isRepeat = false;
// 	featherPaticleSystem->m_initScale = { 4, 5, RANDOM_TYPE::NORMAL };
// 	featherPaticleSystem->m_initAlpha = { 0.7f, 1.f,RANDOM_TYPE::LINEAR };
// 	featherPaticleSystem->m_AlphaVariance = { -0.8f,-0.5f,RANDOM_TYPE::LINEAR,VARIANCE_TYPE::VALUE };
// 	featherPaticleSystem->m_scaleVariance = { 3.0f };
// 	featherPaticleSystem->m_duration = 0.8f;
// 	featherPaticleSystem->m_maxCount = 4;
// 	featherPaticleSystem->m_emitInterval = { 0.0f, 0.01f, RANDOM_TYPE::NONE };
// 	featherPaticleSystem->m_lifeTime = { 0.8f, 0.8f, RANDOM_TYPE::NONE };
