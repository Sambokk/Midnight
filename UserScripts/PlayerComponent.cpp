...
PlayerComponent::PlayerComponent()
	...
	, m_isPlayInverseAnimaition(false), m_isPrevRightDirection(true), m_actor(nullptr), m_isJumpControl(false), m_walkStyle(0)
{
...
void PlayerComponent::Update(float _deltaTime)
{
	...
	else
	{
		...
		{
			// 반중력 토글키
			if (m_myInputManager->IsKeyState(KEY::R, KEY_STATE::TAP) && m_isInputOn && !m_isFreeze)
			{
				// 애니메이션 초기화
