...
public:
	...
	///Box2d 충돌 관련 함수
	virtual void OnBox2dCollisionEnter(GameObject* _otherObj) {};
	virtual void OnBox2dCollisionStay(GameObject* _otherObj) {};
	virtual void OnBox2dCollisionExit(GameObject* _otherObj) {};
	
	virtual void OnBox2dCollisionEnter(b2Contact* _contact) {};
