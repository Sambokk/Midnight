...
public: 
	...
	///Box2d 충돌 관련 함수
	void OnBox2dCollisionEnter(GameObject* _otherObj);
	void OnBox2dCollisionEnter(b2Contact* _contact);

	void OnBox2dCollisionStay(GameObject* _otherObj);
	void OnBox2dCollisionExit(GameObject* _otherObj);
