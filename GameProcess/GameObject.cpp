...
void GameObject::OnBox2dCollisionEnter(GameObject* _otherObj)
{
	if (!m_isActive)
		return;
	...
	for (auto& component : m_components)
	{
		component.second->OnBox2dCollisionEnter(_otherObj);
	}
}

void GameObject::OnBox2dCollisionEnter(b2Contact* _contact)
{
	if (!m_isActive)
		return;
	...
	for (auto& component : m_components)
	{
		component.second->OnBox2dCollisionEnter(_contact);
	}

}

void GameObject::OnBox2dCollisionStay(GameObject* _otherObj)
{
	if (!m_isActive)
		return;
	...
	for (auto& component : m_components)
	{
		component.second->OnBox2dCollisionStay(_otherObj);
	}
}

void GameObject::OnBox2dCollisionExit(GameObject* _otherObj)
{
	if (!m_isActive)
		return;
	...
	for (auto& component : m_components)
	{
		component.second->OnBox2dCollisionExit(_otherObj);
	}
}
